...
def plot_all_snippets(X_test, y_test, name, y_pred_probs, all = True):
    ...
    with Progress() as p:
        ...
        for i in sampled_indices:
            ...
            plt.savefig(f"/home/npapadopoulou/nikoleta/all_n46_9/sample_{i}_probs_vs_true.png")
            plt.close("all")

            p.update(task, advance=1)  
import numpy as np
name = "n46_9_build2_simple6rej8_noseed_scaled_lr001"
X_test= np.load("/home/npapadopoulou/snippets_folder/simple6_snippets_ped150_rej8_flag/ML_accel/x_test.npy")
y_test = np.load("/home/npapadopoulou/snippets_folder/simple6_snippets_ped150_rej8_flag/ML_accel/y_test.npy")
y_pred_probs = np.load("/home/npapadopoulou/wat/eval_mltools/n46_9_build2_simple6rej8_noseed_scaled_lr001/y_pred.npy")
plot_all_snippets(X_test, y_test, name, y_pred_probs=y_pred_probs, all=True)